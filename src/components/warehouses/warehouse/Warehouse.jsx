  ...
  return (
    <>
      <div className="warehouse">
        <Link to="/physicalwarehouse" className="card-warehouse">
          <svg
          ...
          <h3 className="card-title">Physical Warehouse</h3>
        </Link>
        <Link to="/virtualwarehouse" className="card-warehouse">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="100%"
            fill="currentColor"
          ...
          <h3 className="card-title">Virtual Warehouse</h3>
        </Link>
      </div>
    </>
  );
